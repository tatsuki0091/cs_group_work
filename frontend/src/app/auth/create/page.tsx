...
const page = () => {
    const [username, , handleUsername, resetUsername] = useInput<string, HTMLInputElement>("");
    ...
    const [introduction, , handleIntroduction, resetIntroduction] = useInput<string, HTMLTextAreaElement>("");
    ...
    return (
        <>
            <div className="max-w-lg mx-auto  bg-white dark:bg-gray-800 rounded-lg shadow-md px-8 py-10 flex flex-col items-center mt-24 mb-24">
                ...
                <form className="w-full flex flex-col gap-4" onSubmit={sendCreateRequest}>
